...
return [
    ...
    */
    ...
    'paths' => ['api/*', 'sanctum/csrf-cookie', 'login', 'register', 'logout', 'dashboard', 'etudiants', '*', 'matieres', 'etudiants/matieres/{id_matiere}', 'inscriptions/parcoursId'],  // Routes API et Sanctum
